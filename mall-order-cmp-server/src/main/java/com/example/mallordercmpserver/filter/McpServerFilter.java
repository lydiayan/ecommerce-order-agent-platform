 ...
 */
package com.example.mallordercmpserver.filter;

import com.example.mallordercmpserver.util.UserInfoHolder;
...
/**
 * @author yingzi
 * @description 摘自spring ai alibaba的官方demo 原作者yingzi
 * @since 2025/9/17
 */
@Component
public class McpServerFilter implements WebFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        if (true) {
            ...
            UserInfoHolder.setUserInfo("yingzi");
