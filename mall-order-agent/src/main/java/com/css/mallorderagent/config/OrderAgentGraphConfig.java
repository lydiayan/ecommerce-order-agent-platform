...
public class OrderAgentGraphConfig {
    ...
    private static final List<String> STATE_KEYS = List.of(
            ...
            AgentGraphKeys.INTENT,
            AgentGraphKeys.INTENT_SOURCE,
            AgentGraphKeys.INTENT_CONFIDENCE,
            AgentGraphKeys.RULE_MATCH_STATUS,
            AgentGraphKeys.CLARIFICATION_REQUIRED,
