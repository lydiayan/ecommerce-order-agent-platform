...
class MallOrderClientSerializationTest {
    ...
    private static final String SAMPLE = """
            [{"orderId":"ORD20250414005","userId":"USER1005","orderTime":"2025-04-14T02:15:56.000+00:00","totalAmount":5499.00,"orderStatus":3,"paymentMethod":"信用卡","shippingAddress":"杭州市西湖区文三路369号","contactPhone":"13800138005","orderDetails":[{"detailId":5,"orderId":"ORD20250414005","productId":"P1004","productName":"OPPO Find X7","quantity":1,"unitPrice":4999.00,"totalPrice":4999.00,"specification":"12GB+256GB 蓝色"}]}]
            """;
    ...
    @Test
    void restClientParameterizedTypeReference_deserializesSample() {
        RestClient client = RestClient.builder()
                .baseUrl("http://localhost:8081")
                .build();
        List<MallOrderDto> orders = client.get()
                .uri("/orders/user/{userId}", "USER1005")
                .retrieve()
